    ...
    return(
        <div id="Bio" className="fade-in-fx">
            ...
            <div className="bio-body">
                ...
                <h2>A <s className="little-strike">Little</s> Lot About Me...</h2>
                <p className="bio-content">
                    ...
                    <br/><br/>                    
                    I eventually decided to take the leap and worked as a Jr. Developer for a digital studio of a well-known ad agency in New York City. The pay wasn't great but the experience was worth it. I worked on a different project every week, exposing myself to more hands on opportunites with HTML, CSS, and JavaScript. However, as the growing demand for email development grew, I was quickly appointed as the point of contact for all digital marketing campaigns.
                    <br/><br/>                    
